...
import { UploadOutlined, LoadingOutlined, LogoutOutlined} from '@ant-design/icons';
...
function HomePage() {
    ...
    // Obtener logout del contexto de autenticación
        ...
        <div style={{ margin: 'auto', paddingTop: '20px' }}>
            ...
            <div style={{ maxWidth: '600px', margin: 'auto', padding: '3px' }}>
                ...
                <Button
                    ...
                    onClick={logout}
                    block
                    style={{ marginTop: '10px', backgroundColor: '#f5222d', color: 'white' }}
                    icon={<LogoutOutlined />}
                >
                    Cerrar Sesión
                </Button>
